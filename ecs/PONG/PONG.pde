// Hadley Delaney | 26 April 2023 | Pong
...
void startScreen() {
  ...
  fill (#BF40BF);
  textSize (30);
  text ("Welcome to Pong!", 260, 200);
  text ("By: Hadley Delaney", 260, 250);
  text ("*press space to start game*", 270, 300);
}
